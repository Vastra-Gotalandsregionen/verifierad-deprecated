	...
	if('<sitemapindex' in str(sitemap)):	# is the sitemap itself an index of sitemaps
		...
		for url in sitemap_content.findAll("loc"):
			...
			for lvl1_url in sitemap_iteration.findAll("loc"):
				#print(lvl1_url.text)
				if (".pdf" not in lvl1_url.text.lower()) and (".jpg" not in lvl1_url.text.lower()) and (".png" not in lvl1_url.text.lower()) and (".gif" not in lvl1_url.text.lower()) and (".eps" not in lvl1_url.text.lower()) and (".doc" not in lvl1_url.text.lower()) and (".docx" not in lvl1_url.text.lower()) and (".xls" not in lvl1_url.text.lower()) and (".xlsx" not in lvl1_url.text.lower()):
		...
		for url in soup.findAll("loc"):
			#print(url.text)
			if (".pdf" not in url.text) and (".jpg" not in url.text) and (".png" not in url.text) and (".gif" not in url.text):
